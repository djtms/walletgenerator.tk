"de": {
    ...
    "paperlabelbitcoinaddress": "Bitcoin-Adres:",
    "paperlabelprivatekey": "Prywatny Schl&uuml;ssel (Wallet Import Format):",
    "paperlabelencryptedkey": "Verschl&uuml;sselter privater Schl&uuml;ssel (Hasło ben&ouml;tigt)",
    "bulkgeneratingaddresses": "Tworzenie adresów... ",
    "brainalertpassphrasetooshort": "Hasło które wpisałeś jest zbyt krótkie.\n\n",
    "brainalertpassphrasewarning": "Uwaga: dłuższe hasło chroni lepiej przed atakami typu brute-force, które próbują losowo zgadywać hasła.",
    ...
    "bip38alertincorrectpassphrase": "Blędne Hasło",
    "bip38alertpassphraserequired": "Proszę wpisać hasło.",
    ...
    "singlewallet": "Pojedyńczy Portfel",
    ...
    "bulka1": "Bisher musste immer der offizielle Bitcoin-Daemon, bitcoind, auf dem Server installiert sein, damit man Bitcoins auf seiner Webseite annehmen konnte. Viele Webhoster blockieren die Installation von bitcoind. Au&szlig;erdem m&uuml;ssen die privaten Schl&uuml;ssel auf dem Server liegen, damit bitcoind funktioniert, obwohl sie dort einfacher gestohlen werden k&ouml;nnen. Mit einem Massen-Wallet brauchst du nur noch die Bitcoin-Adresn und nicht mehr zus&auml;tzlich die privaten Schl&uuml;ssel hochladen. Dadurch musst du dir keine Sorgen mehr machen, dass dein Bitcoin-Wallet gestohlen werden k&ouml;nnte, wenn unberechtigt in deinen Server eingedrungen wird.",
    "bulklabelq2": "Wie kann ich ein Massen-Wallet in meine Webseite integrieren?",
    "bulklabela2li1": "Erstelle mithilfe dieser Seite ganz viele Bitcoin-Adresn (10.000+). Kopiere die CSV-Liste in eine sichere Textdatei auf deinem Computer. Fertige ein Backup dieser Datei an und speichere sie an einem sicheren Ort.",
    "bulklabela2li2": "Importiere die Bitcoin-Adresn in eine Datenbank auf deinem Server. (Lege nur die Bitcoin-Adresn, nicht aber die privaten Schl&uuml;ssel auf deinem Server ab!)",
    ...
    "brainalgorithm": "Algorytm: SHA256 (Passphrase)",
    "brainlabelbitcoinaddress": "Bitcoin-Adres:",
    ...
    "vanitylabelstep1privnotes": "Speichere den obigen privaten Schl&uuml;ssel in einer Textdatei, die du am besten auf einem verschl&uuml;sselten Laufwerk sicherst. Sobald der Vanity-Pool deine personalisierte Bitcoin-Adres gefunden hat, kannst du den zu ihr geh&ouml;renden privaten Schl&uuml;ssel nur mithilfe des vom Pools berechneten privaten Schl&uuml;ssels (Pool Part Private Key) und des obigen privaten Schl&uuml;ssels (Your Part Private Key) erhalten. Beide privaten Schl&uuml;ssel (Pool und Your) werden zum Berechnen des privaten Schl&uuml;ssels deiner personalisierten Bitcoin-Adres ben&ouml;tigt, damit wirklich nur jemand, der beide besitzt, das personalisierte Wallet nutzen kann.",
    ...
    "vanitylabelbitcoinaddress": "Personalisierte Bitcoin-Adres:",
    "vanitylabelnotesbitcoinaddress": "Die obige Bitcoin-Adres sollte den gew&uuml;nschten Pr&auml;fix enthalten.",
    "vanitylabelpublickeyhex": "Personalisierter &ouml;ffentlicher Schl&uuml;ssel (HEX):",
    "vanitylabelnotespublickeyhex": "Die obige Zeichenfolge ist der &ouml;ffentliche Schl&uuml;ssel (Bitcoin-Adres) im Hexadezimalformat.",
    ...
    "detailview": "Zobacz szczegóły",
    "detailprint": "Drukuj",
    "detaillabelnote1": "Der private Schl&uuml;ssel deines Wallets ist eine geheime, einzigartige Zeichenfolge, die nur du kennst. Er kann auf mehrer Arten dargestellt werden. Unten findest du die zugeh&ouml;rige Bitcoin-Adres bzw. &ouml;ffentlichen Schl&uuml;ssel sowie den privaten Schl&uuml;ssel in den verbreitetsten Formaten.",
    ...
    "detaillabelbitcoinaddress": "Bitcoin-Adres:",
    "detaillabelbitcoinaddresscomp": "Komprimierte Bitcoin-Adres:",
    ...
    "detaillabelpassphrase": "Hasło f&uuml;r BIP38 eingeben",
